...
@Slf4j
@Singleton
class KamiHerbOverlay extends OverlayPanel
{
    private final Client client;
    private final KamiherbPlugin plugin;
    private final KamiherbPluginconfig config;

    String timeFormat;
    private String infoStatus = "Starting...";

    @Inject
    private KamiHerbOverlay(final Client client, final KamiherbPlugin plugin, final KamiherbPluginconfig config)
    {
        super(plugin);
        ...
        this.plugin = plugin;
        this.config = config;
        getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "KamiHerb overlay"));
    }
